...
const Varia2 = () => {
  ...
  useEffect(() => {
    ...
    fetch(`http://3.87.25.45/data/02/${qno}`)
    .then(resp => resp.json())
  ...
  const Submitt1 = (e) => {
    e.preventDefault();
    axios.post("http://3.87.25.45/vall1/02",{value1, qno})
    .then(res => {
  ...
  const Submitt2 = (e) => {
    e.preventDefault();
    axios.post("http://3.87.25.45/vall2/02",{value2, qno})
    .then(res => {
      if(res.data.Status === "200") {
        True()
      }
  ...
  const Submitt3 = async (e) => {
    e.preventDefault();
    axios.post("http://3.87.25.45/vall3/02",{value3, qno})
    .then(res => {
      if(res.data.Status === "200") {
        True()
      }
    ...
    const Submitt4 = (e) => {
      e.preventDefault();
      axios.post("http://3.87.25.45/vall4/02",{value4, qno})
      .then(res => {
        if(res.data.Status === "200") {
          True()
        }else{

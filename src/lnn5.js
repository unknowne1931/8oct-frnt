...
const Varia5 = () => {
  ...
  useEffect(() => {
    ...
    fetch(`http://3.87.25.45/data/05/${qno}`)
    .then(resp => resp.json())
  ...
  const Submitt1 = (e) => {
    e.preventDefault();
    axios.post("http://3.87.25.45/vall1/05",{value1, qno})
    .then(res => {
  ...
  const Submitt2 = (e) => {
    e.preventDefault();
    axios.post("http://3.87.25.45/vall2/05",{value2, qno})
    .then(res => {
      if(res.data.Status === "200") {
        True()
      }
  ...
  const Submitt3 = async (e) => {
    e.preventDefault();
    axios.post("http://3.87.25.45/vall3/05",{value3, qno})
    .then(res => {
      if(res.data.Status === "200") {
        True()
      }
    ...
    const Submitt4 = (e) => {
      e.preventDefault();
      axios.post("http://3.87.25.45/vall4/05",{value4, qno})
      .then(res => {
        if(res.data.Status === "200") {
          True()
        }else{
